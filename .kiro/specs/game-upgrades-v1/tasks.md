...
- [x] 1. Extend game state and initialize new properties
 ...
 - [x] 2. Implement player sprite rotation
  - [x] 2.1 Update drawPlayer() function in src/player.js
  ...
  - [x]* 2.2 Write property test for player rotation
    - **Property 1: Player Rotation Correctness**
    - **Validates: Requirements 1.1**
  
  - [x] 2.3 Update main.js to pass mouse coordinates to drawPlayer()
    - Modify drawPlayer() calls to include state.mouse.x and state.mouse.y
    - _Requirements: 1.1_

 - [x] 3. Implement zombie enemy sprites with animation
  - [x] 3.1 Update spawnWave() in src/enemy.js to assign colorTint
    - Add colorTint property to each spawned enemy (random value 0-2)
    - _Requirements: 2.1_
  
  - [x] 3.2 Rewrite drawEnemies() function for zombie sprites
  ...
  - [x]* 3.3 Write property tests for zombie sprites
    - **Property 10: Zombie Color Variation**
    - **Property 11: Shamble Animation Synchronization**
    - **Validates: Requirements 2.1, 2.3, 2.4**

 - [x] 4. Create obstacle system module
  - [x] 4.1 Create src/obstacle.js with generateObstacles() function
  ...
  - [x] 4.2 Add drawObstacles() function to src/obstacle.js
    - Render 40x40 pixel obstacles as stacked brick rectangles
    - Use alternating grey shades for brick pattern
    - _Requirements: 4.6_
  
  - [x]* 4.3 Write property tests for obstacle generation
    - **Property 4: Obstacle Safe Zone**
    - **Property 5: Obstacle Count by Wave**
    - **Property 6: Obstacle Bounds**
    - **Validates: Requirements 4.1, 4.2, 4.3, 4.4, 4.5, 4.7**

 - [x] 5. Checkpoint - Verify visual updates
  - Ensure all tests pass, ask the user if questions arise.

 - [x] 6. Implement obstacle collision detection
  - [x] 6.1 Add checkBulletObstacleCollisions() to src/collision.js
  ...
  - [x] 6.2 Add checkPlayerObstacleCollisions() to src/collision.js
  ...
  - [x]* 6.3 Write property tests for obstacle collision
    - **Property 7: Bullet-Obstacle Collision**
    - **Property 8: Player-Obstacle Collision Resolution**
    - **Validates: Requirements 5.1, 5.2, 5.3**

 - [x] 7. Implement enemy obstacle avoidance
  - [x] 7.1 Update updateEnemies() in src/enemy.js
  ...
  - [x]* 7.2 Write property test for enemy steering
    - **Property 12: Enemy Obstacle Steering**
    - **Validates: Requirements 6.1, 6.2, 6.3, 6.4**

 - [x] 8. Create power-up system module
  - [x] 8.1 Create src/powerup.js with POWER_UPS definitions
 ...
 - [x] 9. Implement power-up selection screen
  ...
  - [x]* 9.3 Write property test for click detection
    - **Property 13: Power-Up Click Detection**
    - **Validates: Requirements 7.2**

 - [x] 10. Checkpoint - Verify power-up system
  - Ensure all tests pass, ask the user if questions arise.

 - [x] 11. Update shooting mechanics with power-up effects
  - [x] 11.1 Refactor fireBullet() in main.js
 ...
 - [x] 15. Final integration and wiring
  - [x] 15.1 Import new modules in main.js
    - Add imports for powerup.js and obstacle.js functions
    - _Requirements: 8.1_
  
  - [x] 15.2 Verify all screen transitions work correctly
